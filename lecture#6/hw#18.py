...
print('--------------------Result--------------------')
all_testers = (test_design_writers + test_scripters + reviewers)
all_testers = list(set(all_testers))
print(f'All testers in the team: {sorted(all_testers)}')

only_testers_scripts = list(
